...
using System.Data;
namespace Building_Managment.BL
{
    class CLS_LOGIN
    {
        ...
        public DataTable SP_LOGIN_VirefayUser(string ID)
        {
            DAL.DataAccessLayer DAL = new DAL.DataAccessLayer();
            ...
            DataTable Dt = new DataTable();
            Dt = DAL.SelectData("SP_LOGIN_VirefayUser", param);
            DAL.Close();
            return Dt;
        }
        ...
        public void EDIT_USER_Password(string User_ID, string Pass_word
       )
        {
            DAL.DataAccessLayer DAL = new DAL.DataAccessLayer();
            DAL.Open();
            ...
            param[1] = new SqlParameter("@Pass_word", SqlDbType.VarChar, 50);
            param[1].Value = Pass_word;
            DAL.ExecuteCommand("EDIT_USER_Password", param);
            DAL.Close();
