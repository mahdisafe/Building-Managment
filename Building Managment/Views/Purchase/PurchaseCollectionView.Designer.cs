namespace Building_Managment.Views.PurchaseCollectionView {
    partial class PurchaseCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "Purchase";
			// 
            // gridControl
            // 
			...
			this.purchaseCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.purchaseCollectionViewBindingSource.DataSource = typeof(Building_Managment.MyCode.Purchase);
			this.gridControl.DataSource = purchaseCollectionViewBindingSource;
            ...
            BuildingPopulateColumnParameters_NotGenerate.FieldName = "Building_ID";
			...
			//PurchasesType1
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters PurchasesType1PopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            PurchasesType1PopulateColumnParameters.FieldName = "PurchasesType1";
            PurchasesType1PopulateColumnParameters.Path = "PurchasesType1.PurchasesDescription";
			parameters.CustomColumnParameters.Add(PurchasesType1PopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters PurchasesType1PopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            PurchasesType1PopulateColumnParameters_NotGenerate.FieldName = "PurchasesType";
		    PurchasesType1PopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(PurchasesType1PopulateColumnParameters_NotGenerate);
									//
			//User_Table
			//
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters PurchasesType1PopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            PurchasesType1PopulateColumnParameters_NotVisible.FieldName = "PurchasesType1";
		    PurchasesType1PopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(PurchasesType1PopulateColumnParameters_NotVisible);
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters PurchasesDetailsPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            PurchasesDetailsPopulateColumnParameters_NotVisible.FieldName = "PurchasesDetails";
		    PurchasesDetailsPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(PurchasesDetailsPopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(Building_Managment.MyCode.Purchase),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Building_Managment.ViewModels.PurchaseCollectionViewModel);
			// 
            // layoutControl
            // 
            ...
            this.Name = "PurchaseCollectionView";
		...
		private System.Windows.Forms.BindingSource purchaseCollectionViewBindingSource;
