...
namespace Building_Managment.Views.PurchaseCollectionView{
    public partial class PurchaseCollectionView : XtraUserControl {
        public PurchaseCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Building_Managment.ViewModels.PurchaseCollectionViewModel>();
