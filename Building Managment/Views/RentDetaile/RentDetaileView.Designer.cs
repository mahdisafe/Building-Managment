    ...
    partial class RentDetaileView {
		...
		private void InitializeComponent() {
			...
			this.PaymentMethodBindingSource = new System.Windows.Forms.BindingSource(this.components);
						this.RentLookUpEdit = new DevExpress.XtraEditors.GridLookUpEdit();
			...
			this.rentDetaileViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.rentDetaileViewBindingSource.DataSource = typeof(Building_Managment.MyCode.RentDetaile);
			this.dataLayoutControl1.DataSource = rentDetaileViewBindingSource;
			//
			//Create GridControls
			//
			...
			this.PaymentMethodLookUpEdit.DataBindings.Add("EditValue", rentDetaileViewBindingSource, "MethodID", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			...
			//RentLookUpEdit
			//
			this.RentBindingSource.DataSource = typeof(Building_Managment.MyCode.Rent);
			this.RentLookUpEdit.Properties.ValueMember = "RentID"; 
			this.RentLookUpEdit.Properties.DisplayMember = "RentID";
			this.RentLookUpEdit.Properties.DataSource = this.RentBindingSource;
			this.RentLookUpEdit.Name = "RentLookUpEdit";
			this.RentLookUpEdit.DataBindings.Add("EditValue", rentDetaileViewBindingSource, "RentID", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			DevExpress.XtraDataLayout.RetrieveFieldParameters RentLookUpEditRetrieveFieldParameters = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
            RentLookUpEditRetrieveFieldParameters.FieldName = "RentID";
            RentLookUpEditRetrieveFieldParameters.ControlForField = this.RentLookUpEdit;
			parameters.CustomListParameters.Add(RentLookUpEditRetrieveFieldParameters);
			DevExpress.XtraDataLayout.RetrieveFieldParameters RentLookUpEditRetrieveFieldParameters_NotGenerate = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
		    RentLookUpEditRetrieveFieldParameters_NotGenerate.FieldName = "Rent";
		    RentLookUpEditRetrieveFieldParameters_NotGenerate.GenerateField = false;
			parameters.CustomListParameters.Add(RentLookUpEditRetrieveFieldParameters_NotGenerate);
            ...
            this.mvvmContext.ViewModelType = typeof(Building_Managment.ViewModels.RentDetaileViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "RentDetaile - Element View";
		...
		private System.Windows.Forms.BindingSource rentDetaileViewBindingSource;
		...
		private System.Windows.Forms.BindingSource PaymentMethodBindingSource;
				private DevExpress.XtraEditors.GridLookUpEdit RentLookUpEdit;
