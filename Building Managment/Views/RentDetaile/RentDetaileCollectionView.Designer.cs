namespace Building_Managment.Views.RentDetaileCollectionView {
    partial class RentDetaileCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "RentDetaile";
			// 
            // gridControl
            // 
			...
			this.rentDetaileCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.rentDetaileCollectionViewBindingSource.DataSource = typeof(Building_Managment.MyCode.RentDetaile);
			this.gridControl.DataSource = rentDetaileCollectionViewBindingSource;
			...
			//Rent
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters RentPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            RentPopulateColumnParameters.FieldName = "Rent";
            RentPopulateColumnParameters.Path = "Rent.RentID";
			parameters.CustomColumnParameters.Add(RentPopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters RentPopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            RentPopulateColumnParameters_NotGenerate.FieldName = "RentID";
		    RentPopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(RentPopulateColumnParameters_NotGenerate);
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters RentPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            RentPopulateColumnParameters_NotVisible.FieldName = "Rent";
		    RentPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(RentPopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(Building_Managment.MyCode.RentDetaile),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Building_Managment.ViewModels.RentDetaileCollectionViewModel);
			// 
            // layoutControl
            // 
            ...
            this.Name = "RentDetaileCollectionView";
		...
		private System.Windows.Forms.BindingSource rentDetaileCollectionViewBindingSource;
