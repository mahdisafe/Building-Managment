...
namespace Building_Managment.Views.RentDetaileCollectionView{
    public partial class RentDetaileCollectionView : XtraUserControl {
        public RentDetaileCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Building_Managment.ViewModels.RentDetaileCollectionViewModel>();
