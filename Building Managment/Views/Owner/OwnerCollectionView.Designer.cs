namespace Building_Managment.Views.OwnerCollectionView {
    partial class OwnerCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
			...
			this.ownerCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.ownerCollectionViewBindingSource.DataSource = typeof(Building_Managment.MyCode.Owner);
			this.gridControl.DataSource = ownerCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters BuildingsPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            BuildingsPopulateColumnParameters_NotVisible.FieldName = "Buildings";
		    BuildingsPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(BuildingsPopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(Building_Managment.MyCode.Owner),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Building_Managment.ViewModels.OwnerCollectionViewModel);
			// 
            // layoutControl
            // 
		...
		private System.Windows.Forms.BindingSource ownerCollectionViewBindingSource;
