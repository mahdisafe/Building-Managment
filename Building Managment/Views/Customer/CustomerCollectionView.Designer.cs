namespace Building_Managment.Views.CustomerCollectionView {
    partial class CustomerCollectionView {
		...
		private void InitializeComponent() {
			...
			this.customerCollectionViewBindingSource.DataSource = typeof(Building_Managment.MyCode.Customer);
			...
			//CustomerType
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters CustomerTypePopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            CustomerTypePopulateColumnParameters.FieldName = "CustomerType";
            CustomerTypePopulateColumnParameters.Path = "CustomerType.CustomerType1";
			parameters.CustomColumnParameters.Add(CustomerTypePopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters CustomerTypePopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            CustomerTypePopulateColumnParameters_NotGenerate.FieldName = "TypeID";
		    CustomerTypePopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(CustomerTypePopulateColumnParameters_NotGenerate);
										
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters CustomerTypePopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            CustomerTypePopulateColumnParameters_NotVisible.FieldName = "CustomerType";
		    CustomerTypePopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(CustomerTypePopulateColumnParameters_NotVisible);
				
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters CustomersAttachmentsPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            CustomersAttachmentsPopulateColumnParameters_NotVisible.FieldName = "CustomersAttachments";
		    CustomersAttachmentsPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(CustomersAttachmentsPopulateColumnParameters_NotVisible);
			...
			this.gridView.PopulateColumns(typeof(Building_Managment.MyCode.Customer),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Building_Managment.ViewModels.CustomerCollectionViewModel);
			// 
            // layoutControl
            // 
