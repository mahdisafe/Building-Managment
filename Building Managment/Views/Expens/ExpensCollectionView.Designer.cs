namespace Building_Managment.Views.ExpensCollectionView {
    partial class ExpensCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
			...
			this.expensCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.expensCollectionViewBindingSource.DataSource = typeof(Building_Managment.MyCode.Expens);
			this.gridControl.DataSource = expensCollectionViewBindingSource;
			...
			//ExpenseType
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters ExpenseTypePopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            ExpenseTypePopulateColumnParameters.FieldName = "ExpenseType";
            ExpenseTypePopulateColumnParameters.Path = "ExpenseType.DescriptionExpenses";
			parameters.CustomColumnParameters.Add(ExpenseTypePopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters ExpenseTypePopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            ExpenseTypePopulateColumnParameters_NotGenerate.FieldName = "ExpType";
		    ExpenseTypePopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(ExpenseTypePopulateColumnParameters_NotGenerate);
									//
			//User_Table
			//
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters ExpenseTypePopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            ExpenseTypePopulateColumnParameters_NotVisible.FieldName = "ExpenseType";
		    ExpenseTypePopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(ExpenseTypePopulateColumnParameters_NotVisible);
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters ExpensessDetailesPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            ExpensessDetailesPopulateColumnParameters_NotVisible.FieldName = "ExpensessDetailes";
		    ExpensessDetailesPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(ExpensessDetailesPopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(Building_Managment.MyCode.Expens),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Building_Managment.ViewModels.ExpensCollectionViewModel);
			// 
            // layoutControl
            // 
            ...
            this.Name = "ExpensCollectionView";
		...
		private System.Windows.Forms.BindingSource expensCollectionViewBindingSource;
