...
namespace Building_Managment.Views.ExpensCollectionView{
    public partial class ExpensCollectionView : XtraUserControl {
        public ExpensCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Building_Managment.ViewModels.ExpensCollectionViewModel>();
