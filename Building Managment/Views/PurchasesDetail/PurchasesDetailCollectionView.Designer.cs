namespace Building_Managment.Views.PurchasesDetailCollectionView {
    partial class PurchasesDetailCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "PurchasesDetail";
			// 
            // gridControl
            // 
			...
			this.purchasesDetailCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.purchasesDetailCollectionViewBindingSource.DataSource = typeof(Building_Managment.MyCode.PurchasesDetail);
			this.gridControl.DataSource = purchasesDetailCollectionViewBindingSource;
			...
			//Purchase
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters PurchasePopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            PurchasePopulateColumnParameters.FieldName = "Purchase";
            PurchasePopulateColumnParameters.Path = "Purchase.Notes";
			parameters.CustomColumnParameters.Add(PurchasePopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters PurchasePopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            PurchasePopulateColumnParameters_NotGenerate.FieldName = "PurchaseID";
		    PurchasePopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(PurchasePopulateColumnParameters_NotGenerate);
										
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters PurchasePopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            PurchasePopulateColumnParameters_NotVisible.FieldName = "Purchase";
		    PurchasePopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(PurchasePopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(Building_Managment.MyCode.PurchasesDetail),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Building_Managment.ViewModels.PurchasesDetailCollectionViewModel);
			// 
            // layoutControl
            // 
            ...
            this.Name = "PurchasesDetailCollectionView";
		...
		private System.Windows.Forms.BindingSource purchasesDetailCollectionViewBindingSource;
