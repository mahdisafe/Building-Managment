...
namespace Building_Managment.Views.PurchasesDetailCollectionView{
    public partial class PurchasesDetailCollectionView : XtraUserControl {
        public PurchasesDetailCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Building_Managment.ViewModels.PurchasesDetailCollectionViewModel>();
