...
namespace Building_Managment.Views.ShopCollectionView{
    public partial class ShopCollectionView : XtraUserControl {
        public ShopCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Building_Managment.ViewModels.ShopCollectionViewModel>();
