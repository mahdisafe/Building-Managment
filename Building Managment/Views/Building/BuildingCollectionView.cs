...
namespace Building_Managment.Views.BuildingCollectionView{
    public partial class BuildingCollectionView : XtraUserControl {
        public BuildingCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Building_Managment.ViewModels.BuildingCollectionViewModel>();
