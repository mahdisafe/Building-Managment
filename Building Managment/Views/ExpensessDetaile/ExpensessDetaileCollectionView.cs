...
namespace Building_Managment.Views.ExpensessDetaileCollectionView{
    public partial class ExpensessDetaileCollectionView : XtraUserControl {
        public ExpensessDetaileCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Building_Managment.ViewModels.ExpensessDetaileCollectionViewModel>();
