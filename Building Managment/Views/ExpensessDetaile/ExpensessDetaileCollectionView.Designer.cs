namespace Building_Managment.Views.ExpensessDetaileCollectionView {
    partial class ExpensessDetaileCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "ExpensessDetaile";
			// 
            // gridControl
            // 
			...
			this.expensessDetaileCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.expensessDetaileCollectionViewBindingSource.DataSource = typeof(Building_Managment.MyCode.ExpensessDetaile);
			this.gridControl.DataSource = expensessDetaileCollectionViewBindingSource;
			...
			//Expens
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters ExpensPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            ExpensPopulateColumnParameters.FieldName = "Expens";
            ExpensPopulateColumnParameters.Path = "Expens.ExpensessDescription";
			parameters.CustomColumnParameters.Add(ExpensPopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters ExpensPopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            ExpensPopulateColumnParameters_NotGenerate.FieldName = "Expensess_ID";
		    ExpensPopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(ExpensPopulateColumnParameters_NotGenerate);
										
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters ExpensPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            ExpensPopulateColumnParameters_NotVisible.FieldName = "Expens";
		    ExpensPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(ExpensPopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(Building_Managment.MyCode.ExpensessDetaile),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Building_Managment.ViewModels.ExpensessDetaileCollectionViewModel);
			// 
            // layoutControl
            // 
			...
			//
			//ExpensessDetaileCollectionView
			//
            ...
            this.Name = "ExpensessDetaileCollectionView";
		...
		private System.Windows.Forms.BindingSource expensessDetaileCollectionViewBindingSource;
