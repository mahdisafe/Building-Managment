...
namespace Building_Managment.Views.Priv_TableCollectionView{
    public partial class Priv_TableCollectionView : XtraUserControl {
        public Priv_TableCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Building_Managment.ViewModels.Priv_TableCollectionViewModel>();
