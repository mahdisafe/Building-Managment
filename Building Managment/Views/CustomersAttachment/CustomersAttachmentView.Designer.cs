namespace Building_Managment.Views.CustomersAttachmentView {
    partial class CustomersAttachmentView {
        /// <summary> 
		...
		private void InitializeComponent() {
			...
			this.customersAttachmentViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.customersAttachmentViewBindingSource.DataSource = typeof(Building_Managment.MyCode.CustomersAttachment);
			this.dataLayoutControl1.DataSource = customersAttachmentViewBindingSource;
			//
			//Create GridControls
			//
			...
			this.CustomerLookUpEdit.DataBindings.Add("EditValue", customersAttachmentViewBindingSource, "CustomerID", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(Building_Managment.ViewModels.CustomersAttachmentViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "CustomersAttachment - Element View";
            ...
            this.Name = "CustomersAttachmentView";
		...
		private System.Windows.Forms.BindingSource customersAttachmentViewBindingSource;
