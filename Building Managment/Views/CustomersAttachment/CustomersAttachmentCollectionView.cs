...
namespace Building_Managment.Views.CustomersAttachmentCollectionView{
    public partial class CustomersAttachmentCollectionView : XtraUserControl {
        public CustomersAttachmentCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Building_Managment.ViewModels.CustomersAttachmentCollectionViewModel>();
