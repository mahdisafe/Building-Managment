...
namespace Building_Managment.Views.Electricity_ShopsBillsCollectionView{
    public partial class Electricity_ShopsBillsCollectionView : XtraUserControl {
        public Electricity_ShopsBillsCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Building_Managment.ViewModels.Electricity_ShopsBillsCollectionViewModel>();
